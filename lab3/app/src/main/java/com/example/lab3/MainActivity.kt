...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragmentInput =
            supportFragmentManager.findFragmentById(R.id.fragment_input) as FragmentInput
        fragmentResult =
            supportFragmentManager.findFragmentById(R.id.fragment_result) as FragmentResult
